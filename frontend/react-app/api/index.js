...
let memoryUsers = [
    { _id: 'u1', name: 'Admin', email: 'admin@sweetcounty.com', password: 'admin', isAdmin: true },
    { _id: 'u2', name: 'Customer', email: 'customer@sweetcounty.com', password: 'customer', isAdmin: false }
];
let memoryOrders = [];
